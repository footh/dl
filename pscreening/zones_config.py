...
zone_padding[2][12] = [-25,0,25,0]
zone_padding[3][12] = zone_padding[4][12] = zone_padding[5][12] = [0,0,50,0]
zone_padding[6][12] = [-50,0,0,0]
zone_padding[7][12] = [-50,0,-20,0]
zone_padding[8][12] = zone_padding[9][12] = [-50,0,0,0]
zone_padding[10][12] = [-25,0,25,0]
zone_padding[14][12] = zone_padding[15][12] = [-25,0,25,0]
